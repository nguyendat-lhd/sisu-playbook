  ...
  <tbody>
    <tr>
      ...
      <td class="feature-item-1">
        <h3>1. Xác định "lý do"</h3>
        <p>Trước khi bắt tay vào xây dựng Trung tâm Xuất sắc về AI (AI CoE), điều quan trọng là phải hiểu rõ lợi ích của việc triển khai Trung tâm AI trong tổ chức. Điều này sẽ giúp bạn xây dựng một luận điểm kinh doanh vững chắc để thúc đẩy sự thay đổi.</p>
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td class="feature-item-5">
        <h3>4. Các hỗ trợ từ chuyên gia</h3>
